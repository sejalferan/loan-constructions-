...
<body>
    ...
    <section id="interface">
        ...
        <h4 style="margin:25px 0px 0px 25px;">Registered Farmers</h4>
  ...
  <table class="table" id="myTable">
    ...
    <?php 
        ...
        while ($result = mysqli_fetch_array($query)) {
          ...
          <td><a href="modify.php?id=<?php echo $result['aadhar'];?>" data-toggle="tooltip" data-placement="top" title="Update">Update</a></td>
        </tr>
