...
?>
     ...
     <h4>Select a Farmer</h4>


   <form action="buyback.php" method="post" class= "form-inline p-3">
    ...
    $_SESSION['aadhar'] = $row['aadhar'];
       ?>
        <div class="row g-0 mt-3">
          ...
          <form action="payment.php?action=view&id=<?php echo $row["aadhar"]; ?>" method="post">
...
<!-- 
              <div class="col-md-2 mb-1">
                <label for="validationDefault02">Loan Amount</label>
                <input type="text" class="form-control" id="validationDefault02" value="<?php echo $row['balance']; ?>" readonly>
              </div>  -->

            </div>

          <div class="form-group mt-2" style="display:flex; flex-direction: row; justify-content: center; align-items: center">
          <label for="name" class="text-nowrap " style="margin-right:10px;">Total Loan Amount </label>
          <input type="text" class="form-control" name="name" id="name" value="<?php echo $row['balance']; ?>" readonly>
          </div>
    
            <button type="submit" value="submit" class="btn btn-primary">Proceed to Payment</button>
